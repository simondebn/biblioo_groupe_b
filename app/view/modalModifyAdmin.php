<div class="modal-content">
    ...
    <form id="formModifyAdministrateur">
        <div class="modal-body" style="padding:0 20%; padding-top:20px">
            ...
            <div class="md-form">
                <input type="password" id="password" class="form-control" ><label for="form1">Mot de passe</label>
            </div>
            <div class="md-form">
                <input type="email" id="email" class="form-control" value="<?= $_POST['email'] ?>"><label for="form1" class="active">Email</label>
            </div>
        </div>
